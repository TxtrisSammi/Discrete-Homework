...
\begin{enumerate}
	\item $|\mathcal{P}| = 3$,
	      % solution here
	      \begin{sol}
		      There are 3 distinct sets, $\{1,2,6,7\},\{3,5\},\{4\}$.
	      \end{sol}
	\item There exists no set $S \in \mathcal{P}$ such that $|S| = 3$,
	      % solution here
	      \begin{sol}
		      None of the sets contain exactly 3 elements.
	      \end{sol}
	\item $3 \ \mathord{\not\mathrel{R}} \ 4 \text{ but } 3 \ R \ 5$,
	      % solution here
	      \begin{sol}
		      We have the set $\{3,5\}$ and do not have $\{3,4\}$
	      \end{sol}
	\item There exists a set $T \in \mathcal{P}$ such that $1, 7 \in T$.
	      % solution here
	      \begin{sol}
		      The set $\{1,2,6,7\}$ contains both 1 and 7.
	      \end{sol}
\end{enumerate}
\begin{sol}
	$R = \{(1,1),(1,2),(1,6),(1,7),(3,3),(3,5),(4,4)\}$
\end{sol}
